    ...
    <style>
        ...
        * {
        ...
        form {
            ...
            gap: 10px 20px; /* Vertical and horizontal gap between columns */
        }
...
<body>
    <div class="container">
        ...
        <form action="UpdateCustomerServlet" method="post">
            ...
            <input type="text" id="accountno" name="accountno" value="${requestScope.accountno}" readonly>
            ...
            <input type="text" id="phoneno" name="phoneno" value="${requestScope.phoneno}" required>
            
            <label for="address">Address :</label>
            <input type="text" id="address" name="address" value="${requestScope.address}" required>
            
            <label for="aadharno">Aadhar Number :</label>
            <input type="text" id="aadharno" name="aadharno" value="${requestScope.aadharno}" required>
